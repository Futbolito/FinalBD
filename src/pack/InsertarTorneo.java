 ...
 * @author Wilthouk
 */
public class InsertarTorneo extends javax.swing.JFrame {

    /**
     * Creates new form InsertarTorneo
     */
    public InsertarTorneo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(304, 186));
        setMinimumSize(new java.awt.Dimension(304, 186));
        setPreferredSize(new java.awt.Dimension(304, 186));
        setResizable(false);
        ...
        btnGuardar.setBounds(180, 120, 91, 25);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertarTorneo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertarTorneo().setVisible(true);
            }
        });
    }
